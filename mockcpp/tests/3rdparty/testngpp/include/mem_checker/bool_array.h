...
public:
    ...
    void initialize(bool __value__);
 ...
 *
 * @param __value__   the new boolean value
 * @return          the assigned boolean value
 */
inline bool bool_array::_Element::operator=(bool __value__)
{
    if (__value__)
